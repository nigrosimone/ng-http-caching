...
describe('provideNgHttpCaching', () => {
  ...
  it('should provide custom config', () => {
    ...
    const providedConfig = TestBed.inject(NG_HTTP_CACHING_CONFIG);
  ...
  it('should handle sentinel and register adapter class', () => {
    ...
    const sentinel = new NgHttpCachingNgSimpleStateSentinel(MockAdapter, adapterConfig);

    TestBed.configureTestingModule({
      providers: [provideNgHttpCaching({ store: sentinel })],
    });
